...
// airportAudio.remobeAttribute("controls");
const pauseButton = document.querySelector("#pause-button");
console.log(pauseButton);
pauseButton.addEventListener("click", pauseAirportAudio);
function playAirportAudio() {console.log(airportAudio); airportAudio.play();}
function pauseAirportAudio() {console.log(airportAudio); airportAudio.pause();}
...
function playPopSound() {popAudio.play();}